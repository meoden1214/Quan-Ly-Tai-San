...
namespace UI_UX_Dashboard_P1.FormUI
{
    public partial class fmXemPhong : Form
    {
        ...
        private void loadDataGV()
        {
            ...
            gvDanhSachTaiSan.Columns[0].HeaderText = "Mã Tài Sản";
            gvDanhSachTaiSan.Columns[1].HeaderText = "Tên Tài Sản";
        ...
        private void loadData()
        {
            ...
            lbTongSoTaiSan.Text = dt2.Rows[0][0].ToString()+" Tài Sản";
        ...
        private void btnXuatBaoCao_Click(object sender, EventArgs e)
        {
            if (gvDanhSachTaiSan.Rows.Count > 0)
            {
                ...
                string path = @"E:\";
                string tenFile = "file_TaiSanTrongPhong_"+lbTenPhong.Text;
